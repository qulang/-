...
void LCD_ShowChar(u16 x,u16 y,u8 word,u8 size);						      //显示一个字符
void LCD_ShowNum(u16 x,u16 y,u32 num,u8 len,u8 size,u8 mode);				//显示 数字
void LCD_ShowNum_color(u16 x,u16 y,u32 num,u8 len,u8 size,u8 mode,u16 brushcolor,u16 backcolor); //显示自定义数字
void LCD_ShowString(u16 x,u16 y,u8 size,u8 *p);		           //显示一个12/16/24字体字符串
void LCD_ShowString_color(u16 x,u16 y,u8 size,u8 *p,u16 brushcolor,u16 backcolor); //显示一个12/16/24字体自定义颜色的字符串
